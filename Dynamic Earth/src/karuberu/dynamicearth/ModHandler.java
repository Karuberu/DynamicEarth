...
public class ModHandler {
	...
	private static void integrateBiomesOPlenty() {
		...
		if (Loader.isModLoaded(modID)) {
			try {
				// TODO: add mudballs from BOP to the ore dictionary as mudblobs.			
		...
		if (Loader.isModLoaded(modID)) {
			try {
			    ...
			    if (DynamicEarth.includeAdobe) {
			        ...
			        thaumcraft.api.ThaumcraftApi.registerComplexObjectTag(DynamicEarth.vase.itemID, ItemVase.getDamage(FluidReference.WATER.getBucketVolumeStack()), (new thaumcraft.api.ObjectTags()).add(thaumcraft.api.EnumTag.WATER, 4));
			        thaumcraft.api.ThaumcraftApi.registerComplexObjectTag(DynamicEarth.vase.itemID, ItemVase.getDamage(FluidReference.MILK.getBucketVolumeStack()), (new thaumcraft.api.ObjectTags()).add(thaumcraft.api.EnumTag.HEAL, 2).add(thaumcraft.api.EnumTag.LIFE, 2));
			        thaumcraft.api.ThaumcraftApi.registerComplexObjectTag(DynamicEarth.vase.itemID, ItemVase.getDamage(FluidReference.SOUP.getBucketVolumeStack()), (new thaumcraft.api.ObjectTags()).add(thaumcraft.api.EnumTag.LIFE, 2));
