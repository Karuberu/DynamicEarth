...
public class BlockMudModFarmland extends BlockMudMod implements ITextureOverlay {
	...
	public BlockMudModFarmland(int id) {
	...
	public Icon getOverlayTexture(IBlockAccess blockAccess, int x, int y, int z, int metadata, int side, int pass) {
		ItemStack itemStack = BlockMudModFarmland.getAssociatedBlock(blockAccess.getBlockMetadata(x, y, z));
		Block block = Block.blocksList[itemStack.itemID];
	...
	public void updateTick(World world, int x, int y, int z, Random random) {
    	...
    	int fertility = BlockMudModFarmland.getFertility(metadata);
    	if (fertility > 0) {
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, int blockId) {
        ...
        } else if (MudMod.includePeat
        && world.getBlockId(x, y + 1, z) == MudMod.peatMoss.blockID
	...
	protected ItemStack getDryBlock(int metadata) {
		...
		&& metadata == PEAT_WET) {
			return farmlandPeatDry == null ? farmlandPeatDry = new ItemStack(MudMod.farmland.blockID, 1, PEAT_DRY) : farmlandPeatDry;
		}
		if (MudMod.includeFertileSoil
		&& metadata == SOIL_WET) {
			return farmlandSoilDry == null ? farmlandSoilDry = new ItemStack(MudMod.farmland.blockID, 1, SOIL_DRY) : farmlandSoilDry;
		}
	...
	protected ItemStack getWetBlock(int metadata) {
		if (MudMod.includePeat
		&& metadata == PEAT_DRY) {
			return farmlandPeatWet == null ? farmlandPeatWet = new ItemStack(MudMod.farmland.blockID, 1, PEAT_WET) : farmlandPeatWet;
		}
		if (MudMod.includeFertileSoil
		&& metadata == SOIL_DRY) {
			return farmlandSoilWet == null ? farmlandSoilWet = new ItemStack(MudMod.farmland.blockID, 1, SOIL_WET) : farmlandSoilWet;
		}
		return null;
	}
	...
	public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
		...
		case PEAT_5:
		case PEAT_6:
		case PEAT_7: return BlockMudModFarmland.getAssociatedBlock(PEAT_WET);
    	}
		return BlockMudModFarmland.getAssociatedBlock(metadata);
	}
    ...
    private static ItemStack getAssociatedBlock(int metadata) {
    	if (metadata == MUD) {
    		return mud == null ? mud = new ItemStack(MudMod.mud.blockID, 1, BlockMud.NORMAL) : mud;
    	}
    	if (MudMod.includePeat) {
    		switch (metadata) {
	    	case PEAT_DRY: return peatDry == null ? peatDry = new ItemStack(MudMod.peat.blockID, 1, BlockPeat.DRY) : peatDry;
			case PEAT_WET: return peatWet == null ? peatWet = new ItemStack(MudMod.peat.blockID, 1, BlockPeat.WET) : peatWet;
			case PEAT_1: return peat1 == null ? peat1 = new ItemStack(MudMod.peat.blockID, 1, BlockPeat.ONE_EIGHTH) : peat1;
			case PEAT_2: return peat2 == null ? peat2 = new ItemStack(MudMod.peat.blockID, 1, BlockPeat.TWO_EIGHTHS) : peat2;
			case PEAT_3: return peat3 == null ? peat3 = new ItemStack(MudMod.peat.blockID, 1, BlockPeat.THREE_EIGHTHS) : peat3;
			case PEAT_4: return peat4 == null ? peat4 = new ItemStack(MudMod.peat.blockID, 1, BlockPeat.FOUR_EIGHTHS) : peat4;
			case PEAT_5: return peat5 == null ? peat5 = new ItemStack(MudMod.peat.blockID, 1, BlockPeat.FIVE_EIGHTHS) : peat5;
			case PEAT_6: return peat6 == null ? peat6 = new ItemStack(MudMod.peat.blockID, 1, BlockPeat.SIX_EIGHTHS) : peat6;
			case PEAT_7: return peat7 == null ? peat7 = new ItemStack(MudMod.peat.blockID, 1, BlockPeat.SEVEN_EIGHTHS) : peat7;
    		}
    	}
    	if (MudMod.includeFertileSoil
    	&& (metadata == SOIL_DRY || metadata == SOIL_WET)) {
    		return soil == null ? soil = new ItemStack(MudMod.fertileSoil.blockID, 1, BlockFertileSoil.SOIL) : soil;
    	}
    	if (MudMod.includeSandySoil
    	&& metadata == SANDY_DRY) {
    		return sandy == null ? sandy = new ItemStack(MudMod.sandySoil.blockID, 1, BlockSandySoil.DIRT) : sandy;
    	}
