...
public class ItemBombLit extends ItemDynamicEarth {
	...
	public boolean getFireCharged() {
		return this.fireCharged;
	}

	private int getDamagePerTick() {
		return ItemBombLit.getMaxFuseBurnTime() / (fuseBurnTime * this.fuseLength);
	}
	...
	public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer player) {
		...
		return ItemBombLit.getUnlitBombStack(itemStack);
	}
